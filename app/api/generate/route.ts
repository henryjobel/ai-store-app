...
export async function POST(req: NextRequest) {
  ...
  if (body.field === 'shortDescription') {
    return NextResponse.json({ value: `Elevate your style with ${baseName}, crafted for all-day comfort and premium feel.` });
  }

  if (body.field === 'seoMetaDescription') {
    return NextResponse.json({ value: `Discover ${baseName} with secure checkout, fast delivery, and launch discounts.` });
  }
